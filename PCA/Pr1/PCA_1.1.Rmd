...
© This material is licensed under a **Creative Commons CC BY-NC-NDCreative Commons CC BY-NC-ND** attribution which allows *works to be downloaded and shared with others, as long as they are referenced, but may not be modified in any way or used commercially*.
...
p2 <- ggplot(data_RBGlass1, aes(x = Al)) +
  geom_histogram() +
...
p3 <- ggplot(data_RBGlass1, aes(x = Al)) +
  ...
  coord_flip() +
  labs(title = "Boxplot of Al", x = "Values", y = "")
...
# Histogram, density and boxplot
# Remember that package 'ggplot2' is required
p1 <- ggplot(data_RBGlass1, aes(x = Fe)) +
  geom_density() +
...
p3 <- ggplot(data_RBGlass1, aes(x = Fe)) +
  geom_boxplot(outlier.colour = "red", outlier.shape = 1, outlier.size = 2) +
  coord_flip() +
  labs(title = "Boxplot of Fe", x = "Values", y = "")
...
# Histogram, density and boxplot
# Remember that package 'ggplot2' is required
p1 <- ggplot(data_RBGlass1, aes(x = Mg)) +
  geom_density() +
  labs(title = "Density function of Mg", x = "Mg", y = "Values")

p2 <- ggplot(data_RBGlass1, aes(x = Mg)) +
  geom_histogram() +
...
p3 <- ggplot(data_RBGlass1, aes(x = Mg)) +
  geom_boxplot(outlier.colour = "red", outlier.shape = 1, outlier.size = 2) +
  coord_flip() +
  labs(title = "Boxplot of Mg", x = "Values", y = "")
...
# Histogram, density and boxplot
# Remember that package 'ggplot2' is required
p1 <- ggplot(data_RBGlass1, aes(x = Ca)) +
  geom_density() +
  labs(title = "Density function of Ca", x = "Ca", y = "Values")

p2 <- ggplot(data_RBGlass1, aes(x = Ca)) +
  geom_histogram() +
...
p3 <- ggplot(data_RBGlass1, aes(x = Ca)) +
  geom_boxplot(outlier.colour = "red", outlier.shape = 1, outlier.size = 2) +
  coord_flip() +
  labs(title = "Boxplot of Ca", x = "Values", y = "")
...
# Histogram, density and boxplot
# Remember that package 'ggplot2' is required
p1 <- ggplot(data_RBGlass1, aes(x = Na)) +
  geom_density() +
  labs(title = "Density function of Na", x = "Na", y = "Values")

p2 <- ggplot(data_RBGlass1, aes(x = Na)) +
  geom_histogram() +
...
p3 <- ggplot(data_RBGlass1, aes(x = Na)) +
  geom_boxplot(outlier.colour = "red", outlier.shape = 1, outlier.size = 2) +
  coord_flip() +
  labs(title = "Boxplot of Na", x = "Values", y = "")
...
# Histogram, density and boxplot
# Remember that package 'ggplot2' is required
p1 <- ggplot(data_RBGlass1, aes(x = K)) +
  geom_density() +
  labs(title = "Density function of K", x = "K", y = "Values")

p2 <- ggplot(data_RBGlass1, aes(x = K)) +
  geom_histogram() +
...
p3 <- ggplot(data_RBGlass1, aes(x = K)) +
  geom_boxplot(outlier.colour = "red", outlier.shape = 1, outlier.size = 2) +
  coord_flip() +
  labs(title = "Boxplot of K", x = "Values", y = "")
...
# Histogram, density and boxplot
# Remember that package 'ggplot2' is required
p1 <- ggplot(data_RBGlass1, aes(x = Ti)) +
  geom_density() +
  labs(title = "Density function of Ti", x = "Ti", y = "Values")

p2 <- ggplot(data_RBGlass1, aes(x = Ti)) +
  geom_histogram() +
...
p3 <- ggplot(data_RBGlass1, aes(x = Ti)) +
  geom_boxplot(outlier.colour = "red", outlier.shape = 1, outlier.size = 2) +
  coord_flip() +
  labs(title = "Boxplot of Ti", x = "Values", y = "")
...
# Histogram, density and boxplot
# Remember that package 'ggplot2' is required
p1 <- ggplot(data_RBGlass1, aes(x = P)) +
  geom_density() +
  labs(title = "Density function of P", x = "P", y = "Values")

p2 <- ggplot(data_RBGlass1, aes(x = P)) +
  geom_histogram() +
...
p3 <- ggplot(data_RBGlass1, aes(x = P)) +
  geom_boxplot(outlier.colour = "red", outlier.shape = 1, outlier.size = 2) +
  coord_flip() +
  labs(title = "Boxplot of P", x = "Values", y = "")
...
# Histogram, density and boxplot
# Remember that package 'ggplot2' is required
p1 <- ggplot(data_RBGlass1, aes(x = Mn)) +
  geom_density() +
  labs(title = "Density function of Mn", x = "Mn", y = "Values")

p2 <- ggplot(data_RBGlass1, aes(x = Mn)) +
  geom_histogram() +
...
p3 <- ggplot(data_RBGlass1, aes(x = Mn)) +
  geom_boxplot(outlier.colour = "red", outlier.shape = 1, outlier.size = 2) +
  coord_flip() +
  labs(title = "Boxplot of Mn", x = "Values", y = "")
...
# Histogram, density and boxplot
# Remember that package 'ggplot2' is required
p1 <- ggplot(data_RBGlass1, aes(x = Sb)) +
  geom_density() +
  labs(title = "Density function of Sb", x = "Sb", y = "Values")

p2 <- ggplot(data_RBGlass1, aes(x = Sb)) +
  geom_histogram() +
...
p3 <- ggplot(data_RBGlass1, aes(x = Sb)) +
  geom_boxplot(outlier.colour = "red", outlier.shape = 1, outlier.size = 2) +
  coord_flip() +
  labs(title = "Boxplot of Sb", x = "Values", y = "")
...
# Histogram, density and boxplot
# Remember that package 'ggplot2' is required
p1 <- ggplot(data_RBGlass1, aes(x = Pb)) +
  geom_density() +
  labs(title = "Density function of Pb", x = "Pb", y = "Values")

p2 <- ggplot(data_RBGlass1, aes(x = Pb)) +
  geom_histogram() +
...
p3 <- ggplot(data_RBGlass1, aes(x = Pb)) +
  geom_boxplot(outlier.colour = "red", outlier.shape = 1, outlier.size = 2) +
  coord_flip() +
  labs(title = "Boxplot of Pb", x = "Values", y = "")
...
p1 <- ggplot(data_RBGlass1, aes(x = factor(1), fill = Site)) +
  geom_bar() +
  coord_polar("y") +
  labs(x = "Site", y = "%")
p2 <- ggplot(data_RBGlass1, aes(x = factor(1), fill = Site)) +
  geom_bar() +
  labs(x = "Site", y = "%")
...
pairs(
  x = data_RBGlass1[, c("Al", "Fe", "Mg", "Ca", "Na", "K", "Ti", "P", "Mn", "Sb", "Pb")],
...
p1 <- ggplot(
  data = data.frame(Explained_variance, pc = 1:11),
...
p2 <- ggplot(
  data = data.frame(Cummulative_variance, pc = 1:11),
